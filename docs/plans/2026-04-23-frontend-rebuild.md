...
**Goal:** 将 Agora 前端从单文件 inline React + Babel 重构为 Vite + React + TypeScript 工程化方案，新增进度感知、Agent 配置、报告浏览、导出、日志等功能，并遵循 Huashu Design 美学规范。
...
**后端修改文件：**
- 修改: `agora/src/web_server.py` — 新增 REST API + WebSocket 事件
- 修改: `agora/src/models.py` — 无需修改（现有模型已足够）
...
**Files:**
- Create: `agora/frontend/package.json`
- Create: `agora/frontend/tsconfig.json`
- Create: `agora/frontend/vite.config.ts`
- Create: `agora/frontend/index.html`
- Create: `agora/frontend/src/main.tsx`
- Create: `agora/frontend/.gitignore`
...
**Files:**
- Create: `agora/frontend/src/styles/reset.css`
- Create: `agora/frontend/src/styles/variables.css`
- Create: `agora/frontend/src/styles/markdown.css`
...
```bash
git add agora/frontend/src/styles/
...
**Files:**
- Create: `agora/frontend/src/types.ts`
- Create: `agora/frontend/src/constants.ts`
...
```bash
git add agora/frontend/src/types.ts agora/frontend/src/constants.ts
...
**Files:**
- Create: `agora/frontend/src/utils/markdown.ts`
- Create: `agora/frontend/src/utils/time.ts`
- Create: `agora/frontend/src/utils/session.ts`
- Create: `agora/frontend/src/utils/export.ts`
...
```bash
git add agora/frontend/src/utils/
...
**Files:**
- Create: `agora/frontend/src/hooks/useWebSocket.ts`
...
```bash
git add agora/frontend/src/hooks/
...
**Files:**
- Create: `agora/frontend/src/hooks/useSession.ts`
...
```bash
git add agora/frontend/src/hooks/useSession.ts
...
**Files:**
- Create: `agora/frontend/src/components/common/RoleBadge.tsx`
- Create: `agora/frontend/src/components/common/ConnectionDot.tsx`
- Create: `agora/frontend/src/components/common/common.module.css`
...
```bash
git add agora/frontend/src/components/common/
...
**Files:**
- Create: `agora/frontend/src/components/Progress/ProgressBar.tsx`
- Create: `agora/frontend/src/components/Progress/ProgressBar.module.css`
- Create: `agora/frontend/src/components/Progress/AgentStatusPanel.tsx`
- Create: `agora/frontend/src/components/Progress/AgentStatusPanel.module.css`
...
```bash
git add agora/frontend/src/components/Progress/
...
**Files:**
- Create: `agora/frontend/src/components/Timeline/MessageBubble.tsx`
- Create: `agora/frontend/src/components/Timeline/MessageBubble.module.css`
- Create: `agora/frontend/src/components/Timeline/PhaseDivider.tsx`
- Create: `agora/frontend/src/components/Timeline/VotingCard.tsx`
- Create: `agora/frontend/src/components/Timeline/VotingCard.module.css`
- Create: `agora/frontend/src/components/Timeline/TypingIndicator.tsx`
